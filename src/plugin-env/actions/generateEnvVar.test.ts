...
describe('generateEnvVarAction', () => {
    ...
    describe('validate', () => {
        ...
        it('should handle errors gracefully', async () => {
            ...
            const result = await generateEnvVarAction.validate(mockRuntime, mockMessage, mockState);
            expect(result).toBe(false);
            expect(loggerSpy).toHaveBeenCalledWith('Error validating GENERATE_ENV_VAR action:', new Error('Test error'));
    ...
    describe('handler', () => {
        ...
        it('should handle missing callback', async () => {
            ...
            expect(loggerSpy).toHaveBeenCalledWith("[GenerateEnvVar] Error in handler: Error: Callback is required for GENERATE_ENV_VAR action");
            loggerSpy.mockRestore();
        });
        ...
        it('should handle missing world ID', async () => {
            ...
            expect(loggerSpy).toHaveBeenCalledWith("[GenerateEnvVar] Error in handler: Error: No WORLD_ID found");
            loggerSpy.mockRestore();
        });
        ...
        it('should handle missing world', async () => {
            ...
            expect(loggerSpy).toHaveBeenCalledWith("[GenerateEnvVar] Error in handler: Error: No environment variables metadata found");
            loggerSpy.mockRestore();
        });
