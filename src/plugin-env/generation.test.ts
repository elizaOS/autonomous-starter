...
import { canGenerateEnvVar, generateScript, getGenerationDescription, generationTemplates, generationDependencies } from './generation';
...
describe('generation', () => {
    describe('canGenerateEnvVar', () => {
        ...
        it('should return true for variables with private key in description', () => {
            expect(canGenerateEnvVar('CRYPTO_KEY', 'config', 'This is a private key for encryption')).toBe(true);
        });
    ...
    describe('generateScript', () => {
        ...
        it('should generate Ed25519 private key script when specified', () => {
            const script = generateScript('ED25519_PRIVATE_KEY', 'private_key', 'test-plugin', 'Ed25519 key for signing');
            expect(script).not.toBeNull();
        ...
        it('should generate base64 secret script when specified', () => {
            const script = generateScript('BASE64_SECRET', 'secret', 'test-plugin', 'A base64 encoded secret');
            expect(script).not.toBeNull();
    ...
    describe('generationTemplates', () => {
        ...
        it('should have JWT secret template', () => {
            expect(generationTemplates.secret.jwt_secret).toContain('randomBytes(32).toString(\'base64url\')');
        });
