...
describe('types', () => {
    describe('EnvVarConfig', () => {
        ...
        it('should support all valid types', () => {
            const types: EnvVarConfig['type'][] = ['api_key', 'private_key', 'public_key', 'secret', 'url', 'config', 'credential'];
        ...
        it('should support all valid statuses', () => {
            const statuses: EnvVarConfig['status'][] = ['missing', 'generating', 'validating', 'invalid', 'valid'];
