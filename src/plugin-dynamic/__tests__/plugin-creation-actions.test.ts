...
describe("Plugin Creation Actions", () => {
    ...
    describe("createPluginAction", () => {
        ...
        it("should validate plugin specification", async () => {
            const invalidSpecs = [
                ...
                { name: "@test/plugin", description: "Valid description", version: "invalid" },
    ...
    describe("createPluginFromDescriptionAction", () => {
        it("should validate with long description", async () => {
            const message = createMockMemory("I need a plugin that manages user preferences with storage and retrieval");
        ...
        it("should create plugin from todo description", async () => {
            ...
            const message = createMockMemory("I need a plugin that manages todo lists with add, remove, and list functionality");
        ...
        it("should create weather plugin from description", async () => {
            ...
            const message = createMockMemory("Create a weather information plugin that can fetch current weather and forecasts");
            const result = await createPluginFromDescriptionAction.handler(runtime, message, state);
        ...
        it("should create database plugin from description", async () => {
            ...
            const message = createMockMemory("Build a database plugin for SQL queries and data management");
            const result = await createPluginFromDescriptionAction.handler(runtime, message, state);
        ...
        it("should create custom plugin for unrecognized type", async () => {
            ...
            const message = createMockMemory("I need a blockchain integration plugin for smart contracts");
            const result = await createPluginFromDescriptionAction.handler(runtime, message, state);
