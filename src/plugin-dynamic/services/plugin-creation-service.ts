...
import { generateActionCode, generateProviderCode, generateServiceCode, generateEvaluatorCode, generatePluginIndex } from "../utils/plugin-templates";
...
export class PluginCreationService extends Service {
    ...
    public readonly capabilityDescription: string = "Plugin creation service with AI-powered code generation";
